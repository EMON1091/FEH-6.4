...
def random_dalvik_bd_all():
    """
    Generate a realistic Dalvik-style Facebook Android User-Agent
    covering popular BD + Global devices (2024–2025 working format).
    Returns:
    ...
    # Facebook app version (realistic ~410–490 range)
    facebook_version = f"{random.randint(410, 490)}.0.0.{random.randint(10, 80)}.{random.randint(70, 240)}"
    ...
    # Build tags (latest ones from Pixel & Samsung firmware)
    build = random.choice([
        "UP1A.240905.001", "UP1A.240805.002", "UP1A.240605.004",
        "TQ3A.240805.002", "TP1A.221005.003", "SP2A.220405.004",
        "RQ3A.210905.001"
    ])
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 6.4
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
